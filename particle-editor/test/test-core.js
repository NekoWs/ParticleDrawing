...
// —— 分辨率变量联动 count ——
const fx5 = { id: 'fx4', name: 'torus', center: [0,0,0], count: 0, style: 'DOT', code: '', vars: {}, duration: 0, step: 5, preset: null, params: null };
applyPreset(fx5, 'torus');
__assert('torus count initial', fx5.count === 45 * 16);
fx5.vars.m.expr = '48';
syncPresetCount(fx5);
__assert('torus count sync', fx5.count === 48 * 16);
